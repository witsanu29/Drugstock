  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarMain">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		<li class="nav-item">
          <a href="main_non_drug.php" class="btn btn-danger">
            <i class="bi bi-arrow-left"></i> กลับหน้ารายงาน
        </a>
        </li>
		<li class="nav-item">
		  <a class="nav-link" href="main_non_drug.php">
			🧴 คลังเวชภัณฑ์มิใช่ยา
		  </a>
		</li>
		<li class="nav-item">
		  <a class="nav-link" href="usage_non_drug.php">
			📋 ใช้เวชภัณฑ์มิใช่ยา
		  </a>
		</li>
		<li class="nav-item">
		  <a class="nav-link" href="report_non_drug_stock.php">
			📊 รายงานคงเหลือเวชภัณฑ์มิใช่ยา
		  </a>
		</li>
		<li class="nav-item">
		  <a class="nav-link" href="report_non_drug_expire.php">
